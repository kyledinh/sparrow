...
Set **huggingface_access_token** in config.py. Note down **sparrow_key** from config.py, it will be required to execute inference and training requests
...
2. Create huggingface_access_token and sparrow_key secret in space settings

3. In config.py, replace huggingface_access_token and sparrow_key variable with this line of code
